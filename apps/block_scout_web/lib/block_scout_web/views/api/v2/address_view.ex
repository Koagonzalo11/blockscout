defmodule BlockScoutWeb.API.V2.AddressView do
  ...
  def prepare_address(address, conn \\ nil) do
    ...
    |> chain_type_fields(
      %{
        address: creation_transaction && creation_transaction.from_address,
